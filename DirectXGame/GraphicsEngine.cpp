...
{
    //Create an array of possible driver types ordered by most efficient to least efficient
    ...
    //Higher the level more features available
    ...
    //Try to use the best driver type to create the DirextX Device 
